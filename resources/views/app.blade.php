...
<head>
    ...
    <title inertia>{{ config('app.name', 'Lavoks') }}</title>

    <!-- Fonts (можешь оставить или убрать) -->
    ...
    <link href="https://fonts.googleapis.com/css2?family=Montserrat:wght@100..900&family=Montserrat+Alternates:wght@400;500;600;700&display=swap" rel="stylesheet">
