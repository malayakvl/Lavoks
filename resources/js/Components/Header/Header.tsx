        ...
        <li>
            <NavigationMenu.Link asChild>
                <a
                    ...
                    ref={forwardedRef}
                >
                    <div className="image-menu-link flex gap-1">
                        ...
                        <div className="text-content relative">
                            <span className="ListItemTextNew">{children}</span>
                        </div>
                    </div>
                </a>
            </NavigationMenu.Link>
...
export default function Header({ categories }: Props) {
    ...
    return (
        <header>
            <div className="w-full bg-[#1e120a]/60 border-b border-[#d4af37]/10 backdrop-blur-sm">
            ...
            <div className="w-full max-w-[1100px] mx-auto px-6 py-1 flex items-center justify-between gap-12">
                ...
                <div className="flex-shrink-0">
                    <img src="/images/header/lavoks_logo.svg" alt="Lavoks" className="w-[200px] h-auto" />
                    <DigitalClock />
                </div>
            ...
            {/* Desktop Navigation */}
            <div className="w-full mx-auto px-0 py-[10px] hidden md:block ">
